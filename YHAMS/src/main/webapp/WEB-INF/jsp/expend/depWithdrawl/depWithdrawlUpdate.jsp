...
<div class="panel panel-default">
  <div class="panel-heading">
	...
	<div class="row mb-3">
	    <label for="inputEmail3" class="col-sm-2 col-form-label">날짜</label><!-- 날짜 -->
	    <div class="col-sm-10">
	      <input type="text" class="form-control" id="ACT_DATE" value=""> 
	    </div>
    </div>
    <div class="row mb-3">
	    <label for="inputPassword3" class="col-sm-2 col-form-label">계좌</label><!-- 계좌 -->
	    <div class="col-sm-10">
	      <select id="ACCOUNT_NM" class="form-select" aria-label="Default select example">
    ...
    <div class="row mb-3">
	    <label for="inputPassword3" class="col-sm-2 col-form-label">입금액</label><!-- 입금액 -->
	    <div class="col-sm-10">
	       <input type="text" class="form-control" id="DEPOSIT_TOTAL" value="${result.DEPOSIT_TOTAL}"> 
	    </div>
    </div>
	<div class="row mb-3">
	    <label for="inputPassword3" class="col-sm-2 col-form-label">지출액</label><!-- 지출액 -->
	    <div class="col-sm-10">
	       <input type="text" class="form-control" id="WITHDRL_TOTAL" value="${result.WITHDRL_TOTAL}">
    	</div>
	</div>
	<div class="row mb-3">
	    <label for="inputPassword3" class="col-sm-2 col-form-label">입출금사유</label><!-- 입출금사유 -->
	    <div class="col-sm-10">
	       <input type="text" class="form-control" id="DESCRIPT" value="${result.DESCRIPT}">
    	</div>
	</div>
	<div class="row mb-3">
	    <label for="inputPassword3" class="col-sm-2 col-form-label">대분류</label><!-- 대분류 -->
	    <div class="col-sm-10">
	...
	<div class="row mb-3">
	    <label for="inputPassword3" class="col-sm-2 col-form-label">소분류</label><!-- 수입분류 -->
	    <div class="col-sm-10">
