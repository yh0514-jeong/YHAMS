...
CREATE TABLE TB_TRAN_DAILY_EXP_PLAN (
	EXP_PLAN_SEQ	VARCHAR(36)	NOT NULL  PRIMARY KEY,
...
ICM_PLAN_CATE_YN CHAR(1) DEFAULT 'N',
EXP_PLAN_CATE_YN CHAR(1) DEFAULT 'N',
